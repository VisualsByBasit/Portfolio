...
const TESTIMONIALS = [
  {
    ...
    avatar: "/testimonials/haris-rabbani.jpg",
    avatarPosition: "72% 58%",
  },
  {
    quote:
    ...
    avatar: "/testimonials/ayla-adil.jpg",
    avatarPosition: "38% 46%",
  },
  {
    quote:
    ...
    avatar: "/testimonials/rayan-saeed.jpg",
...
export default function Testimonials() {
  return (
    <section id="testimonials" className="testimonials-section">
      <p className="section-label">06 · Kind Words</p>
          ...
          <figure key={t.name} className="testimonial-card">
            ...
            <figcaption>
              <span className="testimonial-avatar">
                {/* eslint-disable-next-line @next/next/no-img-element -- fixed-size circular crop, next/image adds no value here */}
                <img
                  src={t.avatar}
                  alt={t.name}
