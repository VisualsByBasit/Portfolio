...
/**
 * Animated dotted glow backdrop (canvas): a staggered dot grid whose
 * dots pulse in brightness, with a soft glow at peak. Used behind the
 * time-zone card's map/chips. Colors default to the site palette
 * (lavender dots, cyan glow).
 */
